...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    Submit: function Submit() {
      ...
      Object.keys(this.$refs).forEach(function (i) {
        _this.$refs[i].dataChange();
      });
    ...
    updateErrorStatus: function updateErrorStatus(model, error) {
      ...
      Object.values(this.status_object).forEach(function (i) {
        if (i.length) _this2.status = "error";
      });
    }
  },
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  , ["value", "onDataChange"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_user_profile_field, {
    ...
    compare_same_value: $data.password,
    type: "password",
    onDataChange: $options.dataChange,
  ...
  /* PROPS */
  , ["value", "compare_same_value", "onDataChange"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    type: "checkbox",
    name: "remember",
