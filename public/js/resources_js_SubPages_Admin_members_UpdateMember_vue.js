...
/* harmony import */ var _components_Objects_Input_InputSelect_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../components/Objects/Input/InputSelect.vue */ "./resources/js/components/Objects/Input/InputSelect.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    InputSingleCheckboxVue: _components_Objects_Input_InputSingleCheckbox_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
    TitleItem: _components_Objects_Title_TitleItem_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
    InputSelect: _components_Objects_Input_InputSelect_vue__WEBPACK_IMPORTED_MODULE_7__["default"]
  },
  setup: function setup(props) {
    return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
      var router, _useStore, dispatch, state, info, user_info, updateUserMember, input_cols, role, roles;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _useStore = (0,vuex__WEBPACK_IMPORTED_MODULE_9__.useStore)(), dispatch = _useStore.dispatch, state = _useStore.state; //info

              info = (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_10__.computed)(function () {
                return props.info;
              }); //如果沒有info跳出
              ...
              user_info = (0,_vue_reactivity__WEBPACK_IMPORTED_MODULE_11__.ref)();
              user_info.value = info.value ? JSON.parse(info.value) : {}; // console.log('updatemember->',user_info);

              updateUserMember = /*#__PURE__*/function () {
              ...
              input_cols = (0,_vue_reactivity__WEBPACK_IMPORTED_MODULE_11__.reactive)([{
                model: "name",
              ...
              role = (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_10__.computed)(function () {
                return state.user_info.role_id;
              });
              roles = (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_10__.computed)(function () {
                return state.userHandler.boss.roles;
              });
              ...
              _context2.next = 13;
              return dispatch("userHandler/getRoles");
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  var _component_input_select = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("input-select");

  var _component_input_single_checkbox_vue = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("input-single-checkbox-vue");

  var _component_admin_input_form_vue = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("admin-input-form-vue");

  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.user_info) + " ", 1
  /* TEXT */
  ), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_title_item, {
    title: "會員 - 編輯會員",
    return_to_route_name: "admin-members"
  }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_title_item, {
    title: "會員資訊"
  }, {
  ...
  }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_admin_input_form_vue, null, {
    form_items: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      ...
      /* PROPS */
      , ["title", "modelValue"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_input_text_vue, {
        ...
        onChange: _cache[3] || (_cache[3] = function ($event) {
          return $setup.dispatch('userHandler/checkEmail', $setup.user_info['password']);
        })
      }, null, 8
      /* PROPS */
      , ["title", "modelValue"])]), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($setup.input_cols, function (col) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          ...
          trim: true,
          modelValue: $setup.user_info[col.model],
          "onUpdate:modelValue": function onUpdateModelValue($event) {
            return $setup.user_info[col.model] = $event;
          },
          onChange: function onChange($event) {
            return $setup.dispatch(col.func_call, $setup.user_info[col.model]);
          }
        }, null, 8
        /* PROPS */
        , ["title", "modelValue", "onUpdate:modelValue", "onChange"])]);
      }), 128
      /* KEYED_FRAGMENT */
      )), $setup.role === 3 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_input_select, {
        required: "",
        title: $setup.TITLE.role_id,
        options: $setup.roles,
        modelValue: $setup.user_info.role_id,
        "onUpdate:modelValue": _cache[4] || (_cache[4] = function ($event) {
          return $setup.user_info.role_id = $event;
        })
      }, null, 8
      /* PROPS */
      , ["title", "options", "modelValue"])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_input_single_checkbox_vue, {
        title: $setup.TITLE.status,
        modelValue: $setup.user_info['status'],
        "onUpdate:modelValue": _cache[5] || (_cache[5] = function ($event) {
          return $setup.user_info['status'] = $event;
        })
      }, null, 8
      /* PROPS */
      , ["title", "modelValue"])];
