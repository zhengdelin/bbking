...
class ArticleAdminController extends GlobalController
{
    public function getArticles()
    {
        ...
        $articles = DB::select("SELECT id, title, content, updated_at, category_id ,(Select name from categories where id = category_id) as category_name FROM articles order by id");
